...
class MiniGameShootingStageRewardExcel:
    __slots__ = ['_tab']
    ...
    @staticmethod
    def AddRewardId(builder, RewardId): builder.PrependInt32Slot(1, RewardId, 0)


    @staticmethod
    def AddClearSection(builder, ClearSection): builder.PrependInt32Slot(2, ClearSection, 0)
