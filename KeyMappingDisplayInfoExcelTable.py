...
class KeyMappingDisplayInfoExcelTable:
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = KeyMappingDisplayInfoExcelTable()
        x.Init(buf, n + offset)
        return x
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from .KeyMappingDisplayInfoExcel import KeyMappingDisplayInfoExcel
            obj = KeyMappingDisplayInfoExcel()
