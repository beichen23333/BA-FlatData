...
class ConstCombatExcel:
    ...
    @staticmethod
    def AddEffectTeleportDistance(builder, EffectTeleportDistance): builder.PrependFloat32Slot(84, EffectTeleportDistance, 0)
    ...
    @staticmethod
    def AddEchelonExtensionEngageTimelinePath(builder, EchelonExtensionEngageTimelinePath): builder.PrependUOffsetTRelativeSlot(88, flatbuffers.number_types.UOffsetTFlags.py_type(EchelonExtensionEngageTimelinePath), 0)

    @staticmethod
    def AddEchelonExtensionEngageWithSupporterTimelinePath(builder, EchelonExtensionEngageWithSupporterTimelinePath): builder.PrependUOffsetTRelativeSlot(89, flatbuffers.number_types.UOffsetTFlags.py_type(EchelonExtensionEngageWithSupporterTimelinePath), 0)

    @staticmethod
    def AddEchelonExtensionVictoryTimelinePath(builder, EchelonExtensionVictoryTimelinePath): builder.PrependUOffsetTRelativeSlot(90, flatbuffers.number_types.UOffsetTFlags.py_type(EchelonExtensionVictoryTimelinePath), 0)

    @staticmethod
    def AddEchelonExtensionEchelonMaxCommonCost(builder, EchelonExtensionEchelonMaxCommonCost): builder.PrependInt32Slot(91, EchelonExtensionEchelonMaxCommonCost, 0)
    ...
    @staticmethod
    def AddEchelonExtensionEchelonInitCommonCost(builder, EchelonExtensionEchelonInitCommonCost): builder.PrependInt32Slot(94, EchelonExtensionEchelonInitCommonCost, 0)
    ...
    @staticmethod
    def AddCheckCheaterMaxUseCostMultiFloorRaid(builder, CheckCheaterMaxUseCostMultiFloorRaid): builder.PrependInt32Slot(98, CheckCheaterMaxUseCostMultiFloorRaid, 0)


    @staticmethod
    def AddExcessiveTouchCheckTime(builder, ExcessiveTouchCheckTime): builder.PrependFloat32Slot(99, ExcessiveTouchCheckTime, 0)


    @staticmethod
    def AddExcessiveTouchCheckCount(builder, ExcessiveTouchCheckCount): builder.PrependInt32Slot(100, ExcessiveTouchCheckCount, 0)


    @staticmethod
    def AddCampaignAlertPopupLevelGap(builder, CampaignAlertPopupLevelGap): builder.PrependInt32Slot(101, CampaignAlertPopupLevelGap, 0)
