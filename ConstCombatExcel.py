...
class ConstCombatExcel:
    ...
    @staticmethod
    def AddWORLDBOSSBATTLEMIDDLE(builder, WORLDBOSSBATTLEMIDDLE): builder.PrependInt32Slot(61, WORLDBOSSBATTLEMIDDLE, 0)


    @staticmethod
    def AddWORLDBOSSBATTLEHIGH(builder, WORLDBOSSBATTLEHIGH): builder.PrependInt32Slot(62, WORLDBOSSBATTLEHIGH, 0)


    @staticmethod
    def AddWORLDBOSSBATTLEVERYHIGH(builder, WORLDBOSSBATTLEVERYHIGH): builder.PrependInt32Slot(63, WORLDBOSSBATTLEVERYHIGH, 0)


    @staticmethod
    def AddWorldRaidAutoSyncTermSecond(builder, WorldRaidAutoSyncTermSecond): builder.PrependInt32Slot(64, WorldRaidAutoSyncTermSecond, 0)


    @staticmethod
    def AddWorldRaidBossHpDecreaseTerm(builder, WorldRaidBossHpDecreaseTerm): builder.PrependInt32Slot(65, WorldRaidBossHpDecreaseTerm, 0)


    @staticmethod
    def AddWorldRaidBossParcelReactionDelay(builder, WorldRaidBossParcelReactionDelay): builder.PrependInt32Slot(66, WorldRaidBossParcelReactionDelay, 0)


    @staticmethod
    def AddRaidRankingJumpMinimumWaitingTime(builder, RaidRankingJumpMinimumWaitingTime): builder.PrependInt32Slot(67, RaidRankingJumpMinimumWaitingTime, 0)
    ...
    @staticmethod
    def AddAuraExitThresholdMargin(builder, AuraExitThresholdMargin): builder.PrependInt32Slot(69, AuraExitThresholdMargin, 0)


    @staticmethod
    def AddTSAInteractionDamageFactor(builder, TSAInteractionDamageFactor): builder.PrependInt32Slot(70, TSAInteractionDamageFactor, 0)


    @staticmethod
    def AddVictoryInteractionRate(builder, VictoryInteractionRate): builder.PrependInt32Slot(71, VictoryInteractionRate, 0)
