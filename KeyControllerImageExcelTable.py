...
class KeyControllerImageExcelTable:
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = KeyControllerImageExcelTable()
        x.Init(buf, n + offset)
        return x
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from .KeyControllerImageExcel import KeyControllerImageExcel
            obj = KeyControllerImageExcel()
