...
class ProductSelectExcel:
    ...
    @staticmethod
    def AddProductSelectionSlot(builder, ProductSelectionSlot): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(ProductSelectionSlot), 0)
    @staticmethod
