...
class LoadingImageExcel:
    ...
    @staticmethod
    def AddImagePathTh(builder, ImagePathTh): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(ImagePathTh), 0)

    @staticmethod
    def AddImagePathTw(builder, ImagePathTw): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(ImagePathTw), 0)

    @staticmethod
    def AddImagePathEn(builder, ImagePathEn): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(ImagePathEn), 0)
