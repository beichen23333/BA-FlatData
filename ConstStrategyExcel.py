...
class ConstStrategyExcel:
    ...
    @staticmethod
    def AddMultiSweepPresetNameMaxLengthKr(builder, MultiSweepPresetNameMaxLengthKr): builder.PrependInt32Slot(21, MultiSweepPresetNameMaxLengthKr, 0)


    @staticmethod
    def AddMultiSweepPresetSelectStageMaxCount(builder, MultiSweepPresetSelectStageMaxCount): builder.PrependInt32Slot(22, MultiSweepPresetSelectStageMaxCount, 0)


    @staticmethod
    def AddMultiSweepPresetMaxSweepCount(builder, MultiSweepPresetMaxSweepCount): builder.PrependInt32Slot(23, MultiSweepPresetMaxSweepCount, 0)


    @staticmethod
    def AddMultiSweepPresetSelectParcelMaxCount(builder, MultiSweepPresetSelectParcelMaxCount): builder.PrependInt32Slot(24, MultiSweepPresetSelectParcelMaxCount, 0)
