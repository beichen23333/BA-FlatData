...
class CharacterCalculationLimitExcel:
    ...
    @staticmethod
    def AddMinValue(builder, MinValue): builder.PrependInt32Slot(3, MinValue, 0)


    @staticmethod
    def AddMaxValue(builder, MaxValue): builder.PrependInt32Slot(4, MaxValue, 0)


    @staticmethod
    def AddLimitStartValueLength(builder, LimitStartValueLength): builder.PrependInt32Slot(5, LimitStartValueLength, 0)


    @staticmethod
    def AddDecreaseRateLength(builder, DecreaseRateLength): builder.PrependInt32Slot(6, DecreaseRateLength, 0)
