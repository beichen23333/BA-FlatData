...
class EventContentMissionExcel:
    ...
    @staticmethod
    def AddChallengeStageShortcut(builder, ChallengeStageShortcut): builder.PrependInt32Slot(15, ChallengeStageShortcut, 0)
    ...
    @staticmethod
    def AddCompleteConditionCount(builder, CompleteConditionCount): builder.PrependInt32Slot(18, CompleteConditionCount, 0)


    @staticmethod
    def AddCompleteConditionParameterLength(builder, CompleteConditionParameterLength): builder.PrependInt32Slot(19, CompleteConditionParameterLength, 0)


    @staticmethod
    def AddCompleteConditionParameterTagLength(builder, CompleteConditionParameterTagLength): builder.PrependInt32Slot(20, CompleteConditionParameterTagLength, 0)
    ...
    @staticmethod
    def AddCompleteConditionMissionIdLength(builder, CompleteConditionMissionIdLength): builder.PrependInt32Slot(22, CompleteConditionMissionIdLength, 0)


    @staticmethod
    def AddCompleteConditionMissionCount(builder, CompleteConditionMissionCount): builder.PrependInt32Slot(23, CompleteConditionMissionCount, 0)


    @staticmethod
    def AddMissionRewardParcelTypeLength(builder, MissionRewardParcelTypeLength): builder.PrependInt32Slot(24, MissionRewardParcelTypeLength, 0)


    @staticmethod
    def AddMissionRewardParcelIdLength(builder, MissionRewardParcelIdLength): builder.PrependInt32Slot(25, MissionRewardParcelIdLength, 0)


    @staticmethod
    def AddMissionRewardAmountLength(builder, MissionRewardAmountLength): builder.PrependInt32Slot(26, MissionRewardAmountLength, 0)


    @staticmethod
    def AddConditionRewardParcelTypeLength(builder, ConditionRewardParcelTypeLength): builder.PrependInt32Slot(27, ConditionRewardParcelTypeLength, 0)


    @staticmethod
    def AddConditionRewardParcelIdLength(builder, ConditionRewardParcelIdLength): builder.PrependInt32Slot(28, ConditionRewardParcelIdLength, 0)


    @staticmethod
    def AddConditionRewardAmountLength(builder, ConditionRewardAmountLength): builder.PrependInt32Slot(29, ConditionRewardAmountLength, 0)
