...
class WorldRaidBossGroupExcel:
    ...
    @staticmethod
    def AddUIHideBeforeSpawn(builder, UIHideBeforeSpawn): builder.PrependBoolSlot(12, UIHideBeforeSpawn, 0)


    @staticmethod
    def AddHideAnotherBossKilled(builder, HideAnotherBossKilled): builder.PrependBoolSlot(13, HideAnotherBossKilled, 0)
    ...
    @staticmethod
    def AddExclusiveOperatorBossSpawn(builder, ExclusiveOperatorBossSpawn): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(ExclusiveOperatorBossSpawn), 0)

    @staticmethod
    def AddExclusiveOperatorBossKill(builder, ExclusiveOperatorBossKill): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(ExclusiveOperatorBossKill), 0)

    @staticmethod
    def AddExclusiveOperatorScenarioBattle(builder, ExclusiveOperatorScenarioBattle): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(ExclusiveOperatorScenarioBattle), 0)
