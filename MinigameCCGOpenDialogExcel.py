...
class MinigameCCGOpenDialogExcel:
    __slots__ = ['_tab']
    ...
    @staticmethod
    def AddPlayOrder(builder, PlayOrder): builder.PrependInt32Slot(1, PlayOrder, 0)
    ...
    @staticmethod
    def AddDialog(builder, Dialog): builder.PrependUint32Slot(3, Dialog, 0)
    ...
    @staticmethod
    def AddVoice(builder, Voice): builder.PrependUint32Slot(5, Voice, 0)
