...
class CharacterDialogFieldExcel:
    ...
    @staticmethod
    def AddLocalizeTH(builder, LocalizeTH): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(LocalizeTH), 0)

    @staticmethod
    def AddLocalizeTW(builder, LocalizeTW): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(LocalizeTW), 0)

    @staticmethod
    def AddLocalizeEN(builder, LocalizeEN): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(LocalizeEN), 0)
