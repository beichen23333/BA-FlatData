...
class EventContentClueExcel:
    ...
    @staticmethod
    def AddClueId(builder, ClueId): builder.PrependInt64Slot(1, ClueId, 0)
    ...
    @staticmethod
    def AddSlotClueImagePath(builder, SlotClueImagePath): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(SlotClueImagePath), 0)

    @staticmethod
    def AddClueImagePath(builder, ClueImagePath): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(ClueImagePath), 0)
    ...
    @staticmethod
    def AddHintUse(builder, HintUse): builder.PrependBoolSlot(8, HintUse, 0)
