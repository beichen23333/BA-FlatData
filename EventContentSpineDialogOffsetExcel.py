...
class EventContentSpineDialogOffsetExcel:
    __slots__ = ['_tab']
    ...
    @staticmethod
    def AddSpineOffsetX(builder, SpineOffsetX): builder.PrependFloat32Slot(3, SpineOffsetX, 0)


    @staticmethod
    def AddSpineOffsetY(builder, SpineOffsetY): builder.PrependFloat32Slot(4, SpineOffsetY, 0)


    @staticmethod
    def AddDialogOffsetX(builder, DialogOffsetX): builder.PrependFloat32Slot(5, DialogOffsetX, 0)


    @staticmethod
    def AddDialogOffsetY(builder, DialogOffsetY): builder.PrependFloat32Slot(6, DialogOffsetY, 0)
