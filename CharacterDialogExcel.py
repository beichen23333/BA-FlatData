...
class CharacterDialogExcel:
    ...
    @staticmethod
    def AddAnimationName(builder, AnimationName): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(AnimationName), 0)

    @staticmethod
    def AddLocalizeKR(builder, LocalizeKR): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(LocalizeKR), 0)

    @staticmethod
    def AddLocalizeJP(builder, LocalizeJP): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(LocalizeJP), 0)

    @staticmethod
    def AddLocalizeTH(builder, LocalizeTH): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(LocalizeTH), 0)

    @staticmethod
    def AddLocalizeTW(builder, LocalizeTW): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(LocalizeTW), 0)
    ...
    @staticmethod
    def AddApplyPosition(builder, ApplyPosition): builder.PrependBoolSlot(21, ApplyPosition, 0)


    @staticmethod
    def AddPosX(builder, PosX): builder.PrependFloat32Slot(22, PosX, 0)


    @staticmethod
    def AddPosY(builder, PosY): builder.PrependFloat32Slot(23, PosY, 0)


    @staticmethod
    def AddCollectionVisible(builder, CollectionVisible): builder.PrependBoolSlot(24, CollectionVisible, 0)


    @staticmethod
    def AddCVCollectionType(builder, CVCollectionType): builder.PrependInt32Slot(25, CVCollectionType, 0)


    @staticmethod
    def AddUnlockFavorRank(builder, UnlockFavorRank): builder.PrependInt64Slot(26, UnlockFavorRank, 0)


    @staticmethod
    def AddUnlockEquipWeapon(builder, UnlockEquipWeapon): builder.PrependBoolSlot(27, UnlockEquipWeapon, 0)


    @staticmethod
    def AddLocalizeCVGroup(builder, LocalizeCVGroup): builder.PrependUOffsetTRelativeSlot(28, flatbuffers.number_types.UOffsetTFlags.py_type(LocalizeCVGroup), 0)

    @staticmethod
    def AddTeenMode(builder, TeenMode): builder.PrependBoolSlot(29, TeenMode, 0)
