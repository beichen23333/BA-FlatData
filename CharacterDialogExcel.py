...
class CharacterDialogExcel:
    ...
    @staticmethod
    def AddUnlockFavorRank(builder, UnlockFavorRank): builder.PrependInt32Slot(22, UnlockFavorRank, 0)
    ...
    @staticmethod
    def AddDurationCN(builder, DurationCN): builder.PrependInt32Slot(25, DurationCN, 0)
