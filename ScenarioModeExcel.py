...
class ScenarioModeExcel:
    ...
    @staticmethod
    def AddVolumeId(builder, VolumeId): builder.PrependInt32Slot(3, VolumeId, 0)


    @staticmethod
    def AddChapterId(builder, ChapterId): builder.PrependInt32Slot(4, ChapterId, 0)


    @staticmethod
    def AddEpisodeId(builder, EpisodeId): builder.PrependInt32Slot(5, EpisodeId, 0)
    ...
    @staticmethod
    def AddEpisodeContinueModeId(builder, EpisodeContinueModeId): builder.PrependInt32Slot(10, EpisodeContinueModeId, 0)


    @staticmethod
    def AddFrontScenarioGroupIdLength(builder, FrontScenarioGroupIdLength): builder.PrependInt32Slot(11, FrontScenarioGroupIdLength, 0)


    @staticmethod
    def AddStrategyId(builder, StrategyId): builder.PrependInt32Slot(12, StrategyId, 0)
    ...
    @staticmethod
    def AddBattleDuration(builder, BattleDuration): builder.PrependInt32Slot(15, BattleDuration, 0)


    @staticmethod
    def AddBackScenarioGroupIdLength(builder, BackScenarioGroupIdLength): builder.PrependInt32Slot(16, BackScenarioGroupIdLength, 0)


    @staticmethod
    def AddClearedModeIdLength(builder, ClearedModeIdLength): builder.PrependInt32Slot(17, ClearedModeIdLength, 0)


    @staticmethod
    def AddScenarioModeRewardId(builder, ScenarioModeRewardId): builder.PrependInt32Slot(18, ScenarioModeRewardId, 0)
    ...
    @staticmethod
    def AddAccountLevelLimit(builder, AccountLevelLimit): builder.PrependInt32Slot(20, AccountLevelLimit, 0)


    @staticmethod
    def AddClearedStageId(builder, ClearedStageId): builder.PrependInt32Slot(21, ClearedStageId, 0)
    ...
    @staticmethod
    def AddEventContentId(builder, EventContentId): builder.PrependInt32Slot(24, EventContentId, 0)
    ...
    @staticmethod
    def AddEventContentCondition(builder, EventContentCondition): builder.PrependInt32Slot(26, EventContentCondition, 0)


    @staticmethod
    def AddEventContentConditionGroup(builder, EventContentConditionGroup): builder.PrependInt32Slot(27, EventContentConditionGroup, 0)
    ...
    @staticmethod
    def AddFixedEchelonId(builder, FixedEchelonId): builder.PrependInt32Slot(35, FixedEchelonId, 0)
    ...
    @staticmethod
    def AddCollectionGroupId(builder, CollectionGroupId): builder.PrependInt32Slot(38, CollectionGroupId, 0)
