...
class ScenarioModeExcel:
    ...
    @staticmethod
    def AddSpecialRewardPrefabName(builder, SpecialRewardPrefabName): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(SpecialRewardPrefabName), 0)

    @staticmethod
    def AddSpecialRewardLogOut(builder, SpecialRewardLogOut): builder.PrependBoolSlot(21, SpecialRewardLogOut, 0)
