...
class CharacterDialogEventExcel:
    ...
    @staticmethod
    def AddCollectionVisible(builder, CollectionVisible): builder.PrependBoolSlot(21, CollectionVisible, 0)


    @staticmethod
    def AddCVCollectionType(builder, CVCollectionType): builder.PrependInt32Slot(22, CVCollectionType, 0)


    @staticmethod
    def AddCVUnlockScenarioType(builder, CVUnlockScenarioType): builder.PrependInt32Slot(23, CVUnlockScenarioType, 0)
