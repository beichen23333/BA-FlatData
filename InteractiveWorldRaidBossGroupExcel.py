...
class InteractiveWorldRaidBossGroupExcel:
    ...
    @staticmethod
    def AddUIHideBeforeSpawn(builder, UIHideBeforeSpawn): builder.PrependBoolSlot(10, UIHideBeforeSpawn, 0)


    @staticmethod
    def AddHideAnotherBossKilled(builder, HideAnotherBossKilled): builder.PrependBoolSlot(11, HideAnotherBossKilled, 0)
    ...
    @staticmethod
    def AddExclusiveOperatorBossSpawn(builder, ExclusiveOperatorBossSpawn): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(ExclusiveOperatorBossSpawn), 0)

    @staticmethod
    def AddExclusiveOperatorBossKill(builder, ExclusiveOperatorBossKill): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(ExclusiveOperatorBossKill), 0)

    @staticmethod
    def AddExclusiveOperatorScenarioBattle(builder, ExclusiveOperatorScenarioBattle): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(ExclusiveOperatorScenarioBattle), 0)
    ...
    @staticmethod
    def AddRaidScenarioBattleLocalizeKey(builder, RaidScenarioBattleLocalizeKey): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(RaidScenarioBattleLocalizeKey), 0)

    @staticmethod
    def AddIsSeasonFinalBoss(builder, IsSeasonFinalBoss): builder.PrependBoolSlot(21, IsSeasonFinalBoss, 0)
