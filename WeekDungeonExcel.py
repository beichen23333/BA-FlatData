...
class WeekDungeonExcel:
    ...
    @staticmethod
    def AddWeekDungeonType(builder, WeekDungeonType): builder.PrependFloat32Slot(1, WeekDungeonType, 0)
    ...
    @staticmethod
    def AddStarGoalLength(builder, StarGoalLength): builder.PrependInt32Slot(9, StarGoalLength, 0)


    @staticmethod
    def AddStarGoalAmountLength(builder, StarGoalAmountLength): builder.PrependInt32Slot(10, StarGoalAmountLength, 0)
    ...
    @staticmethod
    def AddStageRewardId(builder, StageRewardId): builder.PrependInt32Slot(13, StageRewardId, 0)


    @staticmethod
    def AddPlayTimeLimitInSeconds(builder, PlayTimeLimitInSeconds): builder.PrependInt32Slot(14, PlayTimeLimitInSeconds, 0)


    @staticmethod
    def AddBattleRewardExp(builder, BattleRewardExp): builder.PrependInt32Slot(15, BattleRewardExp, 0)


    @staticmethod
    def AddBattleRewardPlayerExp(builder, BattleRewardPlayerExp): builder.PrependInt32Slot(16, BattleRewardPlayerExp, 0)


    @staticmethod
    def AddGroupBuffIDLength(builder, GroupBuffIDLength): builder.PrependInt32Slot(17, GroupBuffIDLength, 0)
