...
class FieldSeasonExcel:
    ...
    @staticmethod
    def AddEntryDateId(builder, EntryDateId): builder.PrependInt32Slot(2, EntryDateId, 0)


    @staticmethod
    def AddInstantEntryDateId(builder, InstantEntryDateId): builder.PrependInt32Slot(3, InstantEntryDateId, 0)
    ...
    @staticmethod
    def AddLobbyBGMChangeStageId(builder, LobbyBGMChangeStageId): builder.PrependInt32Slot(6, LobbyBGMChangeStageId, 0)


    @staticmethod
    def AddFieldPrefabControlID(builder, FieldPrefabControlID): builder.PrependInt32Slot(7, FieldPrefabControlID, 0)
