...
class ShopExcel:
    ...
    @staticmethod
    def AddUseBigPopup(builder, UseBigPopup): builder.PrependBoolSlot(4, UseBigPopup, 0)
    ...
    @staticmethod
    def AddShopUpdateGroupId(builder, ShopUpdateGroupId): builder.PrependInt32Slot(15, ShopUpdateGroupId, 0)
