...
class VideoExcel:
    ...
    @staticmethod
    def AddVideoTeenPath(builder, VideoTeenPath): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(VideoTeenPath), 0)
    @staticmethod
    def StartVideoTeenPathVector(builder, numElems): return builder.StartVector(4, numElems, 4)


    @staticmethod
    def AddSoundPath(builder, SoundPath): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(SoundPath), 0)
    @staticmethod
    def StartSoundPathVector(builder, numElems): return builder.StartVector(4, numElems, 4)


    @staticmethod
    def AddSoundVolume(builder, SoundVolume): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(SoundVolume), 0)
    @staticmethod
