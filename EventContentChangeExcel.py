...
class EventContentChangeExcel:
    ...
    @staticmethod
    def AddChangeCount(builder, ChangeCount): builder.PrependInt32Slot(1, ChangeCount, 0)
    ...
    @staticmethod
    def AddChangeCostId(builder, ChangeCostId): builder.PrependInt32Slot(7, ChangeCostId, 0)
