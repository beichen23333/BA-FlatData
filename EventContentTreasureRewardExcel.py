...
class EventContentTreasureRewardExcel:
    __slots__ = ['_tab']
    ...
    @staticmethod
    def AddTreasureSizeIconPath(builder, TreasureSizeIconPath): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(TreasureSizeIconPath), 0)
