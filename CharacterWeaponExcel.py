...
class CharacterWeaponExcel:
    ...
    @staticmethod
    def AddTags(builder, Tags): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(Tags), 0)
    @staticmethod
    def StartTagsVector(builder, numElems): return builder.StartVector(4, numElems, 4)


    @staticmethod
    def AddUnlock(builder, Unlock): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(Unlock), 0)
    @staticmethod
    def StartUnlockVector(builder, numElems): return builder.StartVector(1, numElems, 1)


    @staticmethod
    def AddRecipeId(builder, RecipeId): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(RecipeId), 0)
    @staticmethod
    def StartRecipeIdVector(builder, numElems): return builder.StartVector(8, numElems, 8)


    @staticmethod
    def AddMaxLevel(builder, MaxLevel): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(MaxLevel), 0)
    @staticmethod
    def StartMaxLevelVector(builder, numElems): return builder.StartVector(4, numElems, 4)


    @staticmethod
    def AddLearnSkillSlot(builder, LearnSkillSlot): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(LearnSkillSlot), 0)
    @staticmethod
