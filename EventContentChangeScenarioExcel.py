...
class EventContentChangeScenarioExcel:
    __slots__ = ['_tab']
    ...
    @staticmethod
    def AddChangeCount(builder, ChangeCount): builder.PrependInt32Slot(2, ChangeCount, 0)


    @staticmethod
    def AddScenarioGroupId(builder, ScenarioGroupId): builder.PrependInt32Slot(3, ScenarioGroupId, 0)
