...
class CampaignStageExcel:
    ...
    @staticmethod
    def AddFirstClearFunnelMessage(builder, FirstClearFunnelMessage): builder.PrependUOffsetTRelativeSlot(30, flatbuffers.number_types.UOffsetTFlags.py_type(FirstClearFunnelMessage), 0)

    @staticmethod
    def AddFirstClearEventMessage(builder, FirstClearEventMessage): builder.PrependUOffsetTRelativeSlot(31, flatbuffers.number_types.UOffsetTFlags.py_type(FirstClearEventMessage), 0)

    @staticmethod
    def AddFirstStartFunnelMessage(builder, FirstStartFunnelMessage): builder.PrependUOffsetTRelativeSlot(32, flatbuffers.number_types.UOffsetTFlags.py_type(FirstStartFunnelMessage), 0)

    @staticmethod
    def AddTacticRewardExp(builder, TacticRewardExp): builder.PrependInt64Slot(33, TacticRewardExp, 0)
    ...
    @staticmethod
    def AddEchelonExtensionType(builder, EchelonExtensionType): builder.PrependInt32Slot(35, EchelonExtensionType, 0)
