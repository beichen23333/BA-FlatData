...
class FormationLocationExcel:
    ...
    @staticmethod
    def AddSlotZLength(builder, SlotZLength): builder.PrependInt32Slot(2, SlotZLength, 0)


    @staticmethod
    def AddSlotXLength(builder, SlotXLength): builder.PrependInt32Slot(3, SlotXLength, 0)
