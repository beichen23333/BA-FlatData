...
class MinigameTBGEncounterRewardExcel:
    __slots__ = ['_tab']
    ...
    @staticmethod
    def AddTBGOptionSuccessType(builder, TBGOptionSuccessType): builder.PrependInt32Slot(2, TBGOptionSuccessType, 0)
    ...
    @staticmethod
    def AddParcelType(builder, ParcelType): builder.PrependInt32Slot(4, ParcelType, 0)
