...
class GuideMissionSeasonExcel:
    ...
    @staticmethod
    def AddSpineCharacterId(builder, SpineCharacterId): builder.PrependInt32Slot(13, SpineCharacterId, 0)
    ...
    @staticmethod
    def AddRequirementParcelId(builder, RequirementParcelId): builder.PrependInt32Slot(20, RequirementParcelId, 0)
    ...
    @staticmethod
    def AddPreSeasonId(builder, PreSeasonId): builder.PrependInt32Slot(24, PreSeasonId, 0)
