...
class ProductAutoSelectionGroupExcel:
    ...
    @staticmethod
    def AddProductAutoSelectionGroupId(builder, ProductAutoSelectionGroupId): builder.PrependInt64Slot(0, ProductAutoSelectionGroupId, 0)
    ...
    @staticmethod
    def AddResultAmount(builder, ResultAmount): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(ResultAmount), 0)
    @staticmethod
    def StartResultAmountVector(builder, numElems): return builder.StartVector(8, numElems, 8)
    ...
    @staticmethod
    def AddConditionParcelId(builder, ConditionParcelId): builder.PrependInt64Slot(6, ConditionParcelId, 0)
