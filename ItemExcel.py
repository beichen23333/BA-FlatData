...
class ItemExcel:
    ...
    @staticmethod
    def AddCraftQualityTier0(builder, CraftQualityTier0): builder.PrependInt64Slot(23, CraftQualityTier0, 0)


    @staticmethod
    def AddCraftQualityTier1(builder, CraftQualityTier1): builder.PrependInt64Slot(24, CraftQualityTier1, 0)


    @staticmethod
    def AddCraftQualityTier2(builder, CraftQualityTier2): builder.PrependInt64Slot(25, CraftQualityTier2, 0)


    @staticmethod
    def AddShiftingCraftQuality(builder, ShiftingCraftQuality): builder.PrependInt64Slot(26, ShiftingCraftQuality, 0)
    ...
    @staticmethod
    def AddShopCategory(builder, ShopCategory): builder.PrependUOffsetTRelativeSlot(28, flatbuffers.number_types.UOffsetTFlags.py_type(ShopCategory), 0)
    @staticmethod
    ...
    @staticmethod
    def AddShortcutTypeId(builder, ShortcutTypeId): builder.PrependInt64Slot(31, ShortcutTypeId, 0)


    @staticmethod
    def AddGachaTicket(builder, GachaTicket): builder.PrependInt32Slot(32, GachaTicket, 0)


    @staticmethod
    def AddAlertPopupId(builder, AlertPopupId): builder.PrependInt64Slot(33, AlertPopupId, 0)


    @staticmethod
    def AddShiftingCraftRecipe(builder, ShiftingCraftRecipe): builder.PrependInt64Slot(34, ShiftingCraftRecipe, 0)
