...
class ItemExcel:
    ...
    @staticmethod
    def AddCraftQualityTier0(builder, CraftQualityTier0): builder.PrependInt32Slot(22, CraftQualityTier0, 0)


    @staticmethod
    def AddCraftQualityTier1(builder, CraftQualityTier1): builder.PrependInt32Slot(23, CraftQualityTier1, 0)


    @staticmethod
    def AddCraftQualityTier2(builder, CraftQualityTier2): builder.PrependInt32Slot(24, CraftQualityTier2, 0)


    @staticmethod
    def AddShiftingCraftQuality(builder, ShiftingCraftQuality): builder.PrependInt32Slot(25, ShiftingCraftQuality, 0)
    ...
    @staticmethod
    def AddShopCategoryLength(builder, ShopCategoryLength): builder.PrependInt32Slot(27, ShopCategoryLength, 0)
    ...
    @staticmethod
    def AddShortcutTypeId(builder, ShortcutTypeId): builder.PrependInt32Slot(30, ShortcutTypeId, 0)
