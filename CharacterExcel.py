...
class CharacterExcel:
    ...
    @staticmethod
    def AddEquipmentSlotLength(builder, EquipmentSlotLength): builder.PrependInt32Slot(38, EquipmentSlotLength, 0)
    ...
    @staticmethod
    def AddBodyRadius(builder, BodyRadius): builder.PrependInt32Slot(41, BodyRadius, 0)


    @staticmethod
    def AddRandomEffectRadius(builder, RandomEffectRadius): builder.PrependInt32Slot(42, RandomEffectRadius, 0)
