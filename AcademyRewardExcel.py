...
class AcademyRewardExcel:
    ...
    @staticmethod
    def AddLocationRank(builder, LocationRank): builder.PrependInt32Slot(6, LocationRank, 0)


    @staticmethod
    def AddFavorExp(builder, FavorExp): builder.PrependInt32Slot(7, FavorExp, 0)


    @staticmethod
    def AddSecretStoneAmount(builder, SecretStoneAmount): builder.PrependInt32Slot(8, SecretStoneAmount, 0)


    @staticmethod
    def AddSecretStoneProb(builder, SecretStoneProb): builder.PrependInt32Slot(9, SecretStoneProb, 0)


    @staticmethod
    def AddExtraFavorExp(builder, ExtraFavorExp): builder.PrependInt32Slot(10, ExtraFavorExp, 0)


    @staticmethod
    def AddExtraFavorExpProb(builder, ExtraFavorExpProb): builder.PrependInt32Slot(11, ExtraFavorExpProb, 0)


    @staticmethod
    def AddExtraRewardParcelTypeLength(builder, ExtraRewardParcelTypeLength): builder.PrependInt32Slot(12, ExtraRewardParcelTypeLength, 0)


    @staticmethod
    def AddExtraRewardParcelIdLength(builder, ExtraRewardParcelIdLength): builder.PrependInt32Slot(13, ExtraRewardParcelIdLength, 0)


    @staticmethod
    def AddExtraRewardAmountLength(builder, ExtraRewardAmountLength): builder.PrependInt32Slot(14, ExtraRewardAmountLength, 0)


    @staticmethod
    def AddExtraRewardProbLength(builder, ExtraRewardProbLength): builder.PrependInt32Slot(15, ExtraRewardProbLength, 0)


    @staticmethod
    def AddIsExtraRewardDisplayedLength(builder, IsExtraRewardDisplayedLength): builder.PrependInt32Slot(16, IsExtraRewardDisplayedLength, 0)
    ...
    @staticmethod
    def AddRewardParcelIdLength(builder, RewardParcelIdLength): builder.PrependInt32Slot(18, RewardParcelIdLength, 0)
