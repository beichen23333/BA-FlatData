...
class GroundExcel:
    ...
    @staticmethod
    def AddLevelNPC(builder, LevelNPC): builder.PrependInt32Slot(7, LevelNPC, 0)


    @staticmethod
    def AddLevelMinion(builder, LevelMinion): builder.PrependInt32Slot(8, LevelMinion, 0)


    @staticmethod
    def AddLevelElite(builder, LevelElite): builder.PrependInt32Slot(9, LevelElite, 0)


    @staticmethod
    def AddLevelChampion(builder, LevelChampion): builder.PrependInt32Slot(10, LevelChampion, 0)


    @staticmethod
    def AddLevelBoss(builder, LevelBoss): builder.PrependInt32Slot(11, LevelBoss, 0)


    @staticmethod
    def AddObstacleLevel(builder, ObstacleLevel): builder.PrependInt32Slot(12, ObstacleLevel, 0)


    @staticmethod
    def AddGradeNPC(builder, GradeNPC): builder.PrependInt32Slot(13, GradeNPC, 0)


    @staticmethod
    def AddGradeMinion(builder, GradeMinion): builder.PrependInt32Slot(14, GradeMinion, 0)


    @staticmethod
    def AddGradeElite(builder, GradeElite): builder.PrependInt32Slot(15, GradeElite, 0)


    @staticmethod
    def AddGradeChampion(builder, GradeChampion): builder.PrependInt32Slot(16, GradeChampion, 0)


    @staticmethod
    def AddGradeBoss(builder, GradeBoss): builder.PrependInt32Slot(17, GradeBoss, 0)


    @staticmethod
    def AddPlayerSightPointAdd(builder, PlayerSightPointAdd): builder.PrependInt32Slot(18, PlayerSightPointAdd, 0)


    @staticmethod
    def AddPlayerSightPointRate(builder, PlayerSightPointRate): builder.PrependInt32Slot(19, PlayerSightPointRate, 0)


    @staticmethod
    def AddPlayerAttackRangeAdd(builder, PlayerAttackRangeAdd): builder.PrependInt32Slot(20, PlayerAttackRangeAdd, 0)


    @staticmethod
    def AddPlayerAttackRangeRate(builder, PlayerAttackRangeRate): builder.PrependInt32Slot(21, PlayerAttackRangeRate, 0)


    @staticmethod
    def AddEnemySightPointAdd(builder, EnemySightPointAdd): builder.PrependInt32Slot(22, EnemySightPointAdd, 0)


    @staticmethod
    def AddEnemySightPointRate(builder, EnemySightPointRate): builder.PrependInt32Slot(23, EnemySightPointRate, 0)


    @staticmethod
    def AddEnemyAttackRangeAdd(builder, EnemyAttackRangeAdd): builder.PrependInt32Slot(24, EnemyAttackRangeAdd, 0)


    @staticmethod
    def AddEnemyAttackRangeRate(builder, EnemyAttackRangeRate): builder.PrependInt32Slot(25, EnemyAttackRangeRate, 0)


    @staticmethod
    def AddPlayerSkillRangeAdd(builder, PlayerSkillRangeAdd): builder.PrependInt32Slot(26, PlayerSkillRangeAdd, 0)


    @staticmethod
    def AddPlayerSkillRangeRate(builder, PlayerSkillRangeRate): builder.PrependInt32Slot(27, PlayerSkillRangeRate, 0)


    @staticmethod
    def AddEnemySkillRangeAdd(builder, EnemySkillRangeAdd): builder.PrependInt32Slot(28, EnemySkillRangeAdd, 0)


    @staticmethod
    def AddEnemySkillRangeRate(builder, EnemySkillRangeRate): builder.PrependInt32Slot(29, EnemySkillRangeRate, 0)


    @staticmethod
    def AddPlayerMinimumPositionGapRate(builder, PlayerMinimumPositionGapRate): builder.PrependInt32Slot(30, PlayerMinimumPositionGapRate, 0)


    @staticmethod
    def AddEnemyMinimumPositionGapRate(builder, EnemyMinimumPositionGapRate): builder.PrependInt32Slot(31, EnemyMinimumPositionGapRate, 0)
    ...
    @staticmethod
    def AddTSSAirUnitHeight(builder, TSSAirUnitHeight): builder.PrependInt32Slot(34, TSSAirUnitHeight, 0)
    ...
    @staticmethod
    def AddBGMId(builder, BGMId): builder.PrependInt32Slot(36, BGMId, 0)
