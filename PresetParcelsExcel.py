...
class PresetParcelsExcel:
    ...
    @staticmethod
    def AddParcelType(builder, ParcelType): builder.PrependInt32Slot(0, ParcelType, 0)
    ...
    @staticmethod
    def AddParcelAmount(builder, ParcelAmount): builder.PrependInt32Slot(3, ParcelAmount, 0)
