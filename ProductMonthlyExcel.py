...
class ProductMonthlyExcel:
    ...
    @staticmethod
    def AddPriceReference(builder, PriceReference): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(PriceReference), 0)

    @staticmethod
    def AddProductTagType(builder, ProductTagType): builder.PrependInt32Slot(6, ProductTagType, 0)


    @staticmethod
    def AddMonthlyDays(builder, MonthlyDays): builder.PrependInt64Slot(7, MonthlyDays, 0)


    @staticmethod
    def AddUseMonthlyProductCheck(builder, UseMonthlyProductCheck): builder.PrependBoolSlot(8, UseMonthlyProductCheck, 0)
    ...
    @staticmethod
    def AddParcelType(builder, ParcelType): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(ParcelType), 0)
    @staticmethod
    def StartParcelTypeVector(builder, numElems): return builder.StartVector(4, numElems, 4)


    @staticmethod
    def AddParcelId(builder, ParcelId): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(ParcelId), 0)
    @staticmethod
    def StartParcelIdVector(builder, numElems): return builder.StartVector(8, numElems, 8)


    @staticmethod
    def AddParcelAmount(builder, ParcelAmount): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(ParcelAmount), 0)
    @staticmethod
    def StartParcelAmountVector(builder, numElems): return builder.StartVector(8, numElems, 8)


    @staticmethod
    def AddEnterCostReduceGroupId(builder, EnterCostReduceGroupId): builder.PrependInt64Slot(13, EnterCostReduceGroupId, 0)


    @staticmethod
    def AddDailyParcelType(builder, DailyParcelType): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(DailyParcelType), 0)
    @staticmethod
    def StartDailyParcelTypeVector(builder, numElems): return builder.StartVector(4, numElems, 4)


    @staticmethod
    def AddDailyParcelId(builder, DailyParcelId): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(DailyParcelId), 0)
    @staticmethod
    def StartDailyParcelIdVector(builder, numElems): return builder.StartVector(8, numElems, 8)


    @staticmethod
    def AddDailyParcelAmount(builder, DailyParcelAmount): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(DailyParcelAmount), 0)
    @staticmethod
