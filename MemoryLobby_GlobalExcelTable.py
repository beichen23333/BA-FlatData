...
class MemoryLobby_GlobalExcelTable:
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = MemoryLobby_GlobalExcelTable()
        x.Init(buf, n + offset)
        return x
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from .MemoryLobby_GlobalExcel import MemoryLobby_GlobalExcel
            obj = MemoryLobby_GlobalExcel()
