...
class ConstCommonExcel:
    ...
    def BattlePassNotifyDateGL(self):
    ...
    def PurchaseMailExpiredDayGL(self):
    ...
    @staticmethod
    def AddCallnameLengthEn(builder, CallnameLengthEn): builder.PrependInt32Slot(133, CallnameLengthEn, 0)


    @staticmethod
    def AddCallnameLengthKr(builder, CallnameLengthKr): builder.PrependInt32Slot(134, CallnameLengthKr, 0)


    @staticmethod
    def AddNicknameLengthKr(builder, NicknameLengthKr): builder.PrependInt32Slot(135, NicknameLengthKr, 0)


    @staticmethod
    def AddClanNameLength(builder, ClanNameLength): builder.PrependInt32Slot(136, ClanNameLength, 0)


    @staticmethod
    def AddCafePresetEditNameLength(builder, CafePresetEditNameLength): builder.PrependInt32Slot(137, CafePresetEditNameLength, 0)


    @staticmethod
    def AddFormationPresetEchelonTabTextLengthKr(builder, FormationPresetEchelonTabTextLengthKr): builder.PrependInt32Slot(138, FormationPresetEchelonTabTextLengthKr, 0)


    @staticmethod
    def AddFormationPresetEchelonSlotTextLengthKr(builder, FormationPresetEchelonSlotTextLengthKr): builder.PrependInt32Slot(139, FormationPresetEchelonSlotTextLengthKr, 0)


    @staticmethod
    def AddCharProfileRowIntervalJp(builder, CharProfileRowIntervalJp): builder.PrependInt32Slot(140, CharProfileRowIntervalJp, 0)


    @staticmethod
    def AddCharProfilePopupRowIntervalKr(builder, CharProfilePopupRowIntervalKr): builder.PrependInt32Slot(141, CharProfilePopupRowIntervalKr, 0)


    @staticmethod
    def AddCharProfilePopupRowIntervalJp(builder, CharProfilePopupRowIntervalJp): builder.PrependInt32Slot(142, CharProfilePopupRowIntervalJp, 0)


    @staticmethod
    def AddBeforehandGachaCount(builder, BeforehandGachaCount): builder.PrependInt32Slot(143, BeforehandGachaCount, 0)
    ...
    @staticmethod
    def AddBeforehandGachaGroupId(builder, BeforehandGachaGroupId): builder.PrependInt32Slot(145, BeforehandGachaGroupId, 0)


    @staticmethod
    def AddRenewalDisplayOrderDay(builder, RenewalDisplayOrderDay): builder.PrependInt32Slot(146, RenewalDisplayOrderDay, 0)
    ...
    @staticmethod
    def AddBirthdayMailStartDate(builder, BirthdayMailStartDate): builder.PrependUOffsetTRelativeSlot(148, flatbuffers.number_types.UOffsetTFlags.py_type(BirthdayMailStartDate), 0)

    @staticmethod
    def AddBirthdayMailRemainDate(builder, BirthdayMailRemainDate): builder.PrependInt32Slot(149, BirthdayMailRemainDate, 0)


    @staticmethod
    def AddBirthdayMailParcelType(builder, BirthdayMailParcelType): builder.PrependInt32Slot(150, BirthdayMailParcelType, 0)
    ...
    @staticmethod
    def AddBirthdayMailParcelAmount(builder, BirthdayMailParcelAmount): builder.PrependInt32Slot(152, BirthdayMailParcelAmount, 0)


    @staticmethod
    def AddClearDeckAverageDeckCount(builder, ClearDeckAverageDeckCount): builder.PrependInt32Slot(153, ClearDeckAverageDeckCount, 0)


    @staticmethod
    def AddClearDeckWorldRaidSaveConditionCoefficient(builder, ClearDeckWorldRaidSaveConditionCoefficient): builder.PrependInt32Slot(154, ClearDeckWorldRaidSaveConditionCoefficient, 0)


    @staticmethod
    def AddClearDeckShowCount(builder, ClearDeckShowCount): builder.PrependInt32Slot(155, ClearDeckShowCount, 0)


    @staticmethod
    def AddCharacterMaxLevel(builder, CharacterMaxLevel): builder.PrependInt32Slot(156, CharacterMaxLevel, 0)


    @staticmethod
    def AddPotentialBonusStatMaxLevelMaxHP(builder, PotentialBonusStatMaxLevelMaxHP): builder.PrependInt32Slot(157, PotentialBonusStatMaxLevelMaxHP, 0)


    @staticmethod
    def AddPotentialBonusStatMaxLevelAttackPower(builder, PotentialBonusStatMaxLevelAttackPower): builder.PrependInt32Slot(158, PotentialBonusStatMaxLevelAttackPower, 0)


    @staticmethod
    def AddPotentialBonusStatMaxLevelHealPower(builder, PotentialBonusStatMaxLevelHealPower): builder.PrependInt32Slot(159, PotentialBonusStatMaxLevelHealPower, 0)


    @staticmethod
    def AddPotentialOpenConditionCharacterLevel(builder, PotentialOpenConditionCharacterLevel): builder.PrependInt32Slot(160, PotentialOpenConditionCharacterLevel, 0)


    @staticmethod
    def AddAssistStrangerMinLevel(builder, AssistStrangerMinLevel): builder.PrependInt32Slot(161, AssistStrangerMinLevel, 0)


    @staticmethod
    def AddClanChattingNoticeCautionDelay(builder, ClanChattingNoticeCautionDelay): builder.PrependFloat32Slot(162, ClanChattingNoticeCautionDelay, 0)


    @staticmethod
    def AddCallNameWaitTimeGL(builder, CallNameWaitTimeGL): builder.PrependFloat32Slot(163, CallNameWaitTimeGL, 0)


    @staticmethod
    def AddAssistStrangerMaxLevel(builder, AssistStrangerMaxLevel): builder.PrependInt32Slot(164, AssistStrangerMaxLevel, 0)


    @staticmethod
    def AddMaxBlockedUserCount(builder, MaxBlockedUserCount): builder.PrependInt32Slot(165, MaxBlockedUserCount, 0)
    ...
    @staticmethod
    def AddCafeRandomVisitMinLastLogin(builder, CafeRandomVisitMinLastLogin): builder.PrependInt32Slot(167, CafeRandomVisitMinLastLogin, 0)


    @staticmethod
    def AddCafeTravelSyncIntervalByMillisec(builder, CafeTravelSyncIntervalByMillisec): builder.PrependInt32Slot(168, CafeTravelSyncIntervalByMillisec, 0)


    @staticmethod
    def AddRankBracketPercentage1(builder, RankBracketPercentage1): builder.PrependInt32Slot(169, RankBracketPercentage1, 0)


    @staticmethod
    def AddRankBracketPercentage2(builder, RankBracketPercentage2): builder.PrependInt32Slot(170, RankBracketPercentage2, 0)


    @staticmethod
    def AddRankBracketPercentage3(builder, RankBracketPercentage3): builder.PrependInt32Slot(171, RankBracketPercentage3, 0)


    @staticmethod
    def AddRankBracketPercentage4(builder, RankBracketPercentage4): builder.PrependInt32Slot(172, RankBracketPercentage4, 0)


    @staticmethod
    def AddRankBracketPercentage5(builder, RankBracketPercentage5): builder.PrependInt32Slot(173, RankBracketPercentage5, 0)


    @staticmethod
    def AddRankBracketPercentage6(builder, RankBracketPercentage6): builder.PrependInt32Slot(174, RankBracketPercentage6, 0)


    @staticmethod
    def AddRankBracketPercentage7(builder, RankBracketPercentage7): builder.PrependInt32Slot(175, RankBracketPercentage7, 0)


    @staticmethod
    def AddExpiryBattlePassItemReceiveDay(builder, ExpiryBattlePassItemReceiveDay): builder.PrependInt32Slot(176, ExpiryBattlePassItemReceiveDay, 0)
    ...
    @staticmethod
    def AddBattlePassEndImminentDay(builder, BattlePassEndImminentDay): builder.PrependInt32Slot(178, BattlePassEndImminentDay, 0)


    @staticmethod
    def AddBattlePassExpIconPath(builder, BattlePassExpIconPath): builder.PrependUOffsetTRelativeSlot(179, flatbuffers.number_types.UOffsetTFlags.py_type(BattlePassExpIconPath), 0)

    @staticmethod
    def AddCafeCameraDragThreshold(builder, CafeCameraDragThreshold): builder.PrependFloat32Slot(180, CafeCameraDragThreshold, 0)


    @staticmethod
    def AddCafeSummonTicketBuyLimitForValidate(builder, CafeSummonTicketBuyLimitForValidate): builder.PrependInt32Slot(181, CafeSummonTicketBuyLimitForValidate, 0)


    @staticmethod
    def AddBattlePassNotifyDateGL(builder, BattlePassNotifyDateGL): builder.PrependInt32Slot(182, BattlePassNotifyDateGL, 0)


    @staticmethod
    def AddPurchaseMailExpiredDayGL(builder, PurchaseMailExpiredDayGL): builder.PrependInt32Slot(183, PurchaseMailExpiredDayGL, 0)
    ...
    @staticmethod
    def AddAutoCraftPresetCountLimit(builder, AutoCraftPresetCountLimit): builder.PrependInt32Slot(187, AutoCraftPresetCountLimit, 0)


    @staticmethod
    def AddAutoCraftNodeSelectCount(builder, AutoCraftNodeSelectCount): builder.PrependInt32Slot(188, AutoCraftNodeSelectCount, 0)


    @staticmethod
    def AddCraftPresetNameMaxLength(builder, CraftPresetNameMaxLength): builder.PrependInt32Slot(189, CraftPresetNameMaxLength, 0)
    ...
    @staticmethod
    def AddScenarioAutoDelayMillisecLong(builder, ScenarioAutoDelayMillisecLong): builder.PrependFloat32Slot(193, ScenarioAutoDelayMillisecLong, 0)


    @staticmethod
    def AddScenarioAutoDelayMillisec(builder, ScenarioAutoDelayMillisec): builder.PrependFloat32Slot(194, ScenarioAutoDelayMillisec, 0)


    @staticmethod
    def AddScenarioAutoDelayMillisecShort(builder, ScenarioAutoDelayMillisecShort): builder.PrependFloat32Slot(195, ScenarioAutoDelayMillisecShort, 0)


    @staticmethod
    def AddScenarioAutoDelayMillisecVeryShort(builder, ScenarioAutoDelayMillisecVeryShort): builder.PrependFloat32Slot(196, ScenarioAutoDelayMillisecVeryShort, 0)


    @staticmethod
    def AddPcBuildEnterInformation(builder, PcBuildEnterInformation): builder.PrependInt32Slot(197, PcBuildEnterInformation, 0)
