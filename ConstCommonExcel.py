...
class ConstCommonExcel:
    ...
    @staticmethod
    def Start(builder): builder.StartObject(190)
    @staticmethod
    ...
    @staticmethod
    def AddAcademyFavorZoneId(builder, AcademyFavorZoneId): builder.PrependInt64Slot(6, AcademyFavorZoneId, 0)


    @staticmethod
    def AddCafePresetSlotCount(builder, CafePresetSlotCount): builder.PrependInt32Slot(7, CafePresetSlotCount, 0)


    @staticmethod
    def AddCafeMonologueIntervalMillisec(builder, CafeMonologueIntervalMillisec): builder.PrependInt64Slot(8, CafeMonologueIntervalMillisec, 0)


    @staticmethod
    def AddCafeMonologueDefaultDuration(builder, CafeMonologueDefaultDuration): builder.PrependInt64Slot(9, CafeMonologueDefaultDuration, 0)


    @staticmethod
    def AddCafeBubbleIdleDurationMilliSec(builder, CafeBubbleIdleDurationMilliSec): builder.PrependInt64Slot(10, CafeBubbleIdleDurationMilliSec, 0)


    @staticmethod
    def AddFindGiftTimeLimit(builder, FindGiftTimeLimit): builder.PrependInt32Slot(11, FindGiftTimeLimit, 0)


    @staticmethod
    def AddCafeAutoChargePeriodInMsc(builder, CafeAutoChargePeriodInMsc): builder.PrependInt32Slot(12, CafeAutoChargePeriodInMsc, 0)


    @staticmethod
    def AddCafeProductionDecimalPosition(builder, CafeProductionDecimalPosition): builder.PrependInt32Slot(13, CafeProductionDecimalPosition, 0)


    @staticmethod
    def AddCafeSetGroupApplyCount(builder, CafeSetGroupApplyCount): builder.PrependInt32Slot(14, CafeSetGroupApplyCount, 0)


    @staticmethod
    def AddWeekDungeonFindGiftRewardLimitCount(builder, WeekDungeonFindGiftRewardLimitCount): builder.PrependInt32Slot(15, WeekDungeonFindGiftRewardLimitCount, 0)


    @staticmethod
    def AddStageFailedCurrencyRefundRate(builder, StageFailedCurrencyRefundRate): builder.PrependInt32Slot(16, StageFailedCurrencyRefundRate, 0)


    @staticmethod
    def AddEnterDeposit(builder, EnterDeposit): builder.PrependInt32Slot(17, EnterDeposit, 0)


    @staticmethod
    def AddAccountMaxLevel(builder, AccountMaxLevel): builder.PrependInt32Slot(18, AccountMaxLevel, 0)


    @staticmethod
    def AddMainSquadExpBonus(builder, MainSquadExpBonus): builder.PrependInt32Slot(19, MainSquadExpBonus, 0)


    @staticmethod
    def AddSupportSquadExpBonus(builder, SupportSquadExpBonus): builder.PrependInt32Slot(20, SupportSquadExpBonus, 0)


    @staticmethod
    def AddAccountExpRatio(builder, AccountExpRatio): builder.PrependInt32Slot(21, AccountExpRatio, 0)


    @staticmethod
    def AddMissionToastLifeTime(builder, MissionToastLifeTime): builder.PrependInt32Slot(22, MissionToastLifeTime, 0)


    @staticmethod
    def AddExpItemInsertLimit(builder, ExpItemInsertLimit): builder.PrependInt32Slot(23, ExpItemInsertLimit, 0)


    @staticmethod
    def AddExpItemInsertAccelTime(builder, ExpItemInsertAccelTime): builder.PrependInt32Slot(24, ExpItemInsertAccelTime, 0)


    @staticmethod
    def AddCharacterLvUpCoefficient(builder, CharacterLvUpCoefficient): builder.PrependInt32Slot(25, CharacterLvUpCoefficient, 0)


    @staticmethod
    def AddEquipmentLvUpCoefficient(builder, EquipmentLvUpCoefficient): builder.PrependInt32Slot(26, EquipmentLvUpCoefficient, 0)


    @staticmethod
    def AddExpEquipInsertLimit(builder, ExpEquipInsertLimit): builder.PrependInt32Slot(27, ExpEquipInsertLimit, 0)


    @staticmethod
    def AddEquipLvUpCoefficient(builder, EquipLvUpCoefficient): builder.PrependInt32Slot(28, EquipLvUpCoefficient, 0)


    @staticmethod
    def AddNicknameLength(builder, NicknameLength): builder.PrependInt32Slot(29, NicknameLength, 0)


    @staticmethod
    def AddCraftDuration(builder, CraftDuration): builder.PrependUOffsetTRelativeSlot(30, flatbuffers.number_types.UOffsetTFlags.py_type(CraftDuration), 0)
    @staticmethod
    def StartCraftDurationVector(builder, numElems): return builder.StartVector(4, numElems, 4)


    @staticmethod
    def AddCraftLimitTime(builder, CraftLimitTime): builder.PrependInt32Slot(31, CraftLimitTime, 0)


    @staticmethod
    def AddShiftingCraftDuration(builder, ShiftingCraftDuration): builder.PrependUOffsetTRelativeSlot(32, flatbuffers.number_types.UOffsetTFlags.py_type(ShiftingCraftDuration), 0)
    @staticmethod
    def StartShiftingCraftDurationVector(builder, numElems): return builder.StartVector(4, numElems, 4)


    @staticmethod
    def AddShiftingCraftTicketConsumeAmount(builder, ShiftingCraftTicketConsumeAmount): builder.PrependInt32Slot(33, ShiftingCraftTicketConsumeAmount, 0)


    @staticmethod
    def AddShiftingCraftSlotMaxCapacity(builder, ShiftingCraftSlotMaxCapacity): builder.PrependInt32Slot(34, ShiftingCraftSlotMaxCapacity, 0)


    @staticmethod
    def AddCraftTicketItemUniqueId(builder, CraftTicketItemUniqueId): builder.PrependInt32Slot(35, CraftTicketItemUniqueId, 0)


    @staticmethod
    def AddCraftTicketConsumeAmount(builder, CraftTicketConsumeAmount): builder.PrependInt32Slot(36, CraftTicketConsumeAmount, 0)


    @staticmethod
    def AddAcademyEnterCostType(builder, AcademyEnterCostType): builder.PrependInt32Slot(37, AcademyEnterCostType, 0)


    @staticmethod
    def AddAcademyEnterCostId(builder, AcademyEnterCostId): builder.PrependInt64Slot(38, AcademyEnterCostId, 0)


    @staticmethod
    def AddAcademyTicketCost(builder, AcademyTicketCost): builder.PrependInt32Slot(39, AcademyTicketCost, 0)


    @staticmethod
    def AddMassangerMessageExpireDay(builder, MassangerMessageExpireDay): builder.PrependInt32Slot(40, MassangerMessageExpireDay, 0)


    @staticmethod
    def AddCraftLeafNodeGenerateLv1Count(builder, CraftLeafNodeGenerateLv1Count): builder.PrependInt32Slot(41, CraftLeafNodeGenerateLv1Count, 0)


    @staticmethod
    def AddCraftLeafNodeGenerateLv2Count(builder, CraftLeafNodeGenerateLv2Count): builder.PrependInt32Slot(42, CraftLeafNodeGenerateLv2Count, 0)


    @staticmethod
    def AddTutorialGachaShopId(builder, TutorialGachaShopId): builder.PrependInt32Slot(43, TutorialGachaShopId, 0)


    @staticmethod
    def AddBeforehandGachaShopId(builder, BeforehandGachaShopId): builder.PrependInt32Slot(44, BeforehandGachaShopId, 0)


    @staticmethod
    def AddTutorialGachaGoodsId(builder, TutorialGachaGoodsId): builder.PrependInt32Slot(45, TutorialGachaGoodsId, 0)


    @staticmethod
    def AddEquipmentSlotOpenLevel(builder, EquipmentSlotOpenLevel): builder.PrependUOffsetTRelativeSlot(46, flatbuffers.number_types.UOffsetTFlags.py_type(EquipmentSlotOpenLevel), 0)
    @staticmethod
    def StartEquipmentSlotOpenLevelVector(builder, numElems): return builder.StartVector(4, numElems, 4)


    @staticmethod
    def AddJoinOrCreateClanCoolTimeFromHour(builder, JoinOrCreateClanCoolTimeFromHour): builder.PrependInt64Slot(47, JoinOrCreateClanCoolTimeFromHour, 0)


    @staticmethod
    def AddClanMaxMember(builder, ClanMaxMember): builder.PrependInt64Slot(48, ClanMaxMember, 0)


    @staticmethod
    def AddClanSearchResultCount(builder, ClanSearchResultCount): builder.PrependInt64Slot(49, ClanSearchResultCount, 0)


    @staticmethod
    def AddClanMaxApplicant(builder, ClanMaxApplicant): builder.PrependInt64Slot(50, ClanMaxApplicant, 0)


    @staticmethod
    def AddClanRejoinCoolTimeFromSecond(builder, ClanRejoinCoolTimeFromSecond): builder.PrependInt64Slot(51, ClanRejoinCoolTimeFromSecond, 0)
    ...
    @staticmethod
    def AddCallNameRenameCoolTimeFromHour(builder, CallNameRenameCoolTimeFromHour): builder.PrependInt64Slot(53, CallNameRenameCoolTimeFromHour, 0)


    @staticmethod
    def AddCallNameMinimumLength(builder, CallNameMinimumLength): builder.PrependInt64Slot(54, CallNameMinimumLength, 0)


    @staticmethod
    def AddCallNameMaximumLength(builder, CallNameMaximumLength): builder.PrependInt64Slot(55, CallNameMaximumLength, 0)


    @staticmethod
    def AddLobbyToScreenModeWaitTime(builder, LobbyToScreenModeWaitTime): builder.PrependInt64Slot(56, LobbyToScreenModeWaitTime, 0)


    @staticmethod
    def AddScreenshotToLobbyButtonHideDelay(builder, ScreenshotToLobbyButtonHideDelay): builder.PrependInt64Slot(57, ScreenshotToLobbyButtonHideDelay, 0)


    @staticmethod
    def AddPrologueScenarioID01(builder, PrologueScenarioID01): builder.PrependInt64Slot(58, PrologueScenarioID01, 0)


    @staticmethod
    def AddPrologueScenarioID02(builder, PrologueScenarioID02): builder.PrependInt64Slot(59, PrologueScenarioID02, 0)


    @staticmethod
    def AddTutorialHardStage11(builder, TutorialHardStage11): builder.PrependInt64Slot(60, TutorialHardStage11, 0)


    @staticmethod
    def AddTutorialSpeedButtonStage(builder, TutorialSpeedButtonStage): builder.PrependInt64Slot(61, TutorialSpeedButtonStage, 0)


    @staticmethod
    def AddTutorialCharacterDefaultCount(builder, TutorialCharacterDefaultCount): builder.PrependInt64Slot(62, TutorialCharacterDefaultCount, 0)


    @staticmethod
    def AddTutorialShopCategoryType(builder, TutorialShopCategoryType): builder.PrependInt32Slot(63, TutorialShopCategoryType, 0)


    @staticmethod
    def AddAdventureStrategyPlayTimeLimitInSeconds(builder, AdventureStrategyPlayTimeLimitInSeconds): builder.PrependInt64Slot(64, AdventureStrategyPlayTimeLimitInSeconds, 0)
    ...
    @staticmethod
    def AddRequestTimeOut(builder, RequestTimeOut): builder.PrependFloat32Slot(73, RequestTimeOut, 0)
    ...
    @staticmethod
    def AddLimitedStageDailyClearCount(builder, LimitedStageDailyClearCount): builder.PrependInt64Slot(87, LimitedStageDailyClearCount, 0)


    @staticmethod
    def AddLimitedStageEntryTimeLimit(builder, LimitedStageEntryTimeLimit): builder.PrependInt64Slot(88, LimitedStageEntryTimeLimit, 0)


    @staticmethod
    def AddLimitedStageEntryTimeBuffer(builder, LimitedStageEntryTimeBuffer): builder.PrependInt64Slot(89, LimitedStageEntryTimeBuffer, 0)


    @staticmethod
    def AddLimitedStagePointAmount(builder, LimitedStagePointAmount): builder.PrependInt64Slot(90, LimitedStagePointAmount, 0)


    @staticmethod
    def AddLimitedStagePointPerApMin(builder, LimitedStagePointPerApMin): builder.PrependInt64Slot(91, LimitedStagePointPerApMin, 0)


    @staticmethod
    def AddLimitedStagePointPerApMax(builder, LimitedStagePointPerApMax): builder.PrependInt64Slot(92, LimitedStagePointPerApMax, 0)
    ...
    @staticmethod
    def AddRaidEnterCostId(builder, RaidEnterCostId): builder.PrependInt64Slot(98, RaidEnterCostId, 0)


    @staticmethod
    def AddRaidTicketCost(builder, RaidTicketCost): builder.PrependInt64Slot(99, RaidTicketCost, 0)
    ...
    @staticmethod
    def AddTimeAttackDungeonEnterCostId(builder, TimeAttackDungeonEnterCostId): builder.PrependInt64Slot(103, TimeAttackDungeonEnterCostId, 0)


    @staticmethod
    def AddTimeAttackDungeonEnterCost(builder, TimeAttackDungeonEnterCost): builder.PrependInt64Slot(104, TimeAttackDungeonEnterCost, 0)


    @staticmethod
    def AddClanLeaderTransferLastLoginLimit(builder, ClanLeaderTransferLastLoginLimit): builder.PrependInt64Slot(105, ClanLeaderTransferLastLoginLimit, 0)
    ...
    @staticmethod
    def AddCommonFavorItemTags(builder, CommonFavorItemTags): builder.PrependUOffsetTRelativeSlot(107, flatbuffers.number_types.UOffsetTFlags.py_type(CommonFavorItemTags), 0)
    @staticmethod
    def StartCommonFavorItemTagsVector(builder, numElems): return builder.StartVector(4, numElems, 4)


    @staticmethod
    def AddMaxApMasterCoinPerWeek(builder, MaxApMasterCoinPerWeek): builder.PrependInt64Slot(108, MaxApMasterCoinPerWeek, 0)


    @staticmethod
    def AddCraftOpenExpTier1(builder, CraftOpenExpTier1): builder.PrependInt64Slot(109, CraftOpenExpTier1, 0)


    @staticmethod
    def AddCraftOpenExpTier2(builder, CraftOpenExpTier2): builder.PrependInt64Slot(110, CraftOpenExpTier2, 0)


    @staticmethod
    def AddCraftOpenExpTier3(builder, CraftOpenExpTier3): builder.PrependInt64Slot(111, CraftOpenExpTier3, 0)


    @staticmethod
    def AddCharacterEquipmentGearSlot(builder, CharacterEquipmentGearSlot): builder.PrependInt64Slot(112, CharacterEquipmentGearSlot, 0)


    @staticmethod
    def AddBirthDayDDay(builder, BirthDayDDay): builder.PrependInt32Slot(113, BirthDayDDay, 0)


    @staticmethod
    def AddRecommendedFriendsLvDifferenceLimit(builder, RecommendedFriendsLvDifferenceLimit): builder.PrependInt32Slot(114, RecommendedFriendsLvDifferenceLimit, 0)


    @staticmethod
    def AddDDosDetectCount(builder, DDosDetectCount): builder.PrependInt32Slot(115, DDosDetectCount, 0)


    @staticmethod
    def AddDDosCheckIntervalInSeconds(builder, DDosCheckIntervalInSeconds): builder.PrependInt32Slot(116, DDosCheckIntervalInSeconds, 0)


    @staticmethod
    def AddMaxFriendsCount(builder, MaxFriendsCount): builder.PrependInt32Slot(117, MaxFriendsCount, 0)


    @staticmethod
    def AddMaxFriendsRequest(builder, MaxFriendsRequest): builder.PrependInt32Slot(118, MaxFriendsRequest, 0)


    @staticmethod
    def AddFriendsSearchRequestCount(builder, FriendsSearchRequestCount): builder.PrependInt32Slot(119, FriendsSearchRequestCount, 0)


    @staticmethod
    def AddFriendsMaxApplicant(builder, FriendsMaxApplicant): builder.PrependInt32Slot(120, FriendsMaxApplicant, 0)


    @staticmethod
    def AddIdCardDefaultCharacterId(builder, IdCardDefaultCharacterId): builder.PrependInt64Slot(121, IdCardDefaultCharacterId, 0)


    @staticmethod
    def AddIdCardDefaultBgId(builder, IdCardDefaultBgId): builder.PrependInt64Slot(122, IdCardDefaultBgId, 0)


    @staticmethod
    def AddWorldRaidGemEnterCost(builder, WorldRaidGemEnterCost): builder.PrependInt64Slot(123, WorldRaidGemEnterCost, 0)


    @staticmethod
    def AddWorldRaidGemEnterAmout(builder, WorldRaidGemEnterAmout): builder.PrependInt64Slot(124, WorldRaidGemEnterAmout, 0)


    @staticmethod
    def AddFriendIdCardCommentMaxLength(builder, FriendIdCardCommentMaxLength): builder.PrependInt64Slot(125, FriendIdCardCommentMaxLength, 0)


    @staticmethod
    def AddFormationPresetNumberOfEchelonTab(builder, FormationPresetNumberOfEchelonTab): builder.PrependInt32Slot(126, FormationPresetNumberOfEchelonTab, 0)


    @staticmethod
    def AddFormationPresetNumberOfEchelon(builder, FormationPresetNumberOfEchelon): builder.PrependInt32Slot(127, FormationPresetNumberOfEchelon, 0)


    @staticmethod
    def AddFormationPresetRecentNumberOfEchelon(builder, FormationPresetRecentNumberOfEchelon): builder.PrependInt32Slot(128, FormationPresetRecentNumberOfEchelon, 0)


    @staticmethod
    def AddFormationPresetEchelonTabTextLength(builder, FormationPresetEchelonTabTextLength): builder.PrependInt32Slot(129, FormationPresetEchelonTabTextLength, 0)


    @staticmethod
    def AddFormationPresetEchelonSlotTextLength(builder, FormationPresetEchelonSlotTextLength): builder.PrependInt32Slot(130, FormationPresetEchelonSlotTextLength, 0)


    @staticmethod
    def AddCharProfileRowIntervalKr(builder, CharProfileRowIntervalKr): builder.PrependInt32Slot(131, CharProfileRowIntervalKr, 0)


    @staticmethod
    def AddCharProfileRowIntervalJp(builder, CharProfileRowIntervalJp): builder.PrependInt32Slot(132, CharProfileRowIntervalJp, 0)


    @staticmethod
    def AddCharProfilePopupRowIntervalKr(builder, CharProfilePopupRowIntervalKr): builder.PrependInt32Slot(133, CharProfilePopupRowIntervalKr, 0)


    @staticmethod
    def AddCharProfilePopupRowIntervalJp(builder, CharProfilePopupRowIntervalJp): builder.PrependInt32Slot(134, CharProfilePopupRowIntervalJp, 0)


    @staticmethod
    def AddBeforehandGachaCount(builder, BeforehandGachaCount): builder.PrependInt32Slot(135, BeforehandGachaCount, 0)


    @staticmethod
    def AddBeforehandGachaGroupId(builder, BeforehandGachaGroupId): builder.PrependInt32Slot(136, BeforehandGachaGroupId, 0)


    @staticmethod
    def AddRenewalDisplayOrderDay(builder, RenewalDisplayOrderDay): builder.PrependInt32Slot(137, RenewalDisplayOrderDay, 0)


    @staticmethod
    def AddEmblemDefaultId(builder, EmblemDefaultId): builder.PrependInt64Slot(138, EmblemDefaultId, 0)


    @staticmethod
    def AddBirthdayMailStartDate(builder, BirthdayMailStartDate): builder.PrependUOffsetTRelativeSlot(139, flatbuffers.number_types.UOffsetTFlags.py_type(BirthdayMailStartDate), 0)

    @staticmethod
    def AddBirthdayMailRemainDate(builder, BirthdayMailRemainDate): builder.PrependInt32Slot(140, BirthdayMailRemainDate, 0)


    @staticmethod
    def AddBirthdayMailParcelType(builder, BirthdayMailParcelType): builder.PrependInt32Slot(141, BirthdayMailParcelType, 0)


    @staticmethod
    def AddBirthdayMailParcelId(builder, BirthdayMailParcelId): builder.PrependInt64Slot(142, BirthdayMailParcelId, 0)


    @staticmethod
    def AddBirthdayMailParcelAmount(builder, BirthdayMailParcelAmount): builder.PrependInt32Slot(143, BirthdayMailParcelAmount, 0)


    @staticmethod
    def AddClearDeckAverageDeckCount(builder, ClearDeckAverageDeckCount): builder.PrependInt32Slot(144, ClearDeckAverageDeckCount, 0)


    @staticmethod
    def AddClearDeckWorldRaidSaveConditionCoefficient(builder, ClearDeckWorldRaidSaveConditionCoefficient): builder.PrependInt32Slot(145, ClearDeckWorldRaidSaveConditionCoefficient, 0)


    @staticmethod
    def AddClearDeckShowCount(builder, ClearDeckShowCount): builder.PrependInt32Slot(146, ClearDeckShowCount, 0)


    @staticmethod
    def AddCharacterMaxLevel(builder, CharacterMaxLevel): builder.PrependInt32Slot(147, CharacterMaxLevel, 0)


    @staticmethod
    def AddPotentialBonusStatMaxLevelMaxHP(builder, PotentialBonusStatMaxLevelMaxHP): builder.PrependInt32Slot(148, PotentialBonusStatMaxLevelMaxHP, 0)


    @staticmethod
    def AddPotentialBonusStatMaxLevelAttackPower(builder, PotentialBonusStatMaxLevelAttackPower): builder.PrependInt32Slot(149, PotentialBonusStatMaxLevelAttackPower, 0)


    @staticmethod
    def AddPotentialBonusStatMaxLevelHealPower(builder, PotentialBonusStatMaxLevelHealPower): builder.PrependInt32Slot(150, PotentialBonusStatMaxLevelHealPower, 0)


    @staticmethod
    def AddPotentialOpenConditionCharacterLevel(builder, PotentialOpenConditionCharacterLevel): builder.PrependInt32Slot(151, PotentialOpenConditionCharacterLevel, 0)


    @staticmethod
    def AddAssistStrangerMinLevel(builder, AssistStrangerMinLevel): builder.PrependInt32Slot(152, AssistStrangerMinLevel, 0)


    @staticmethod
    def AddAssistStrangerMaxLevel(builder, AssistStrangerMaxLevel): builder.PrependInt32Slot(153, AssistStrangerMaxLevel, 0)


    @staticmethod
    def AddMaxBlockedUserCount(builder, MaxBlockedUserCount): builder.PrependInt32Slot(154, MaxBlockedUserCount, 0)


    @staticmethod
    def AddCafeRandomVisitMinComfortBonus(builder, CafeRandomVisitMinComfortBonus): builder.PrependInt64Slot(155, CafeRandomVisitMinComfortBonus, 0)


    @staticmethod
    def AddCafeRandomVisitMinLastLogin(builder, CafeRandomVisitMinLastLogin): builder.PrependInt32Slot(156, CafeRandomVisitMinLastLogin, 0)


    @staticmethod
    def AddCafeTravelSyncIntervalByMillisec(builder, CafeTravelSyncIntervalByMillisec): builder.PrependInt32Slot(157, CafeTravelSyncIntervalByMillisec, 0)


    @staticmethod
    def AddRankBracketPercentage1(builder, RankBracketPercentage1): builder.PrependInt32Slot(158, RankBracketPercentage1, 0)


    @staticmethod
    def AddRankBracketPercentage2(builder, RankBracketPercentage2): builder.PrependInt32Slot(159, RankBracketPercentage2, 0)


    @staticmethod
    def AddRankBracketPercentage3(builder, RankBracketPercentage3): builder.PrependInt32Slot(160, RankBracketPercentage3, 0)


    @staticmethod
    def AddRankBracketPercentage4(builder, RankBracketPercentage4): builder.PrependInt32Slot(161, RankBracketPercentage4, 0)


    @staticmethod
    def AddRankBracketPercentage5(builder, RankBracketPercentage5): builder.PrependInt32Slot(162, RankBracketPercentage5, 0)


    @staticmethod
    def AddRankBracketPercentage6(builder, RankBracketPercentage6): builder.PrependInt32Slot(163, RankBracketPercentage6, 0)


    @staticmethod
    def AddRankBracketPercentage7(builder, RankBracketPercentage7): builder.PrependInt32Slot(164, RankBracketPercentage7, 0)


    @staticmethod
    def AddExpiryBattlePassItemReceiveDay(builder, ExpiryBattlePassItemReceiveDay): builder.PrependInt32Slot(165, ExpiryBattlePassItemReceiveDay, 0)


    @staticmethod
    def AddBattlePassFlavorTextIdleDurationMilliSec(builder, BattlePassFlavorTextIdleDurationMilliSec): builder.PrependInt64Slot(166, BattlePassFlavorTextIdleDurationMilliSec, 0)


    @staticmethod
    def AddBattlePassEndImminentDay(builder, BattlePassEndImminentDay): builder.PrependInt32Slot(167, BattlePassEndImminentDay, 0)


    @staticmethod
    def AddBattlePassExpIconPath(builder, BattlePassExpIconPath): builder.PrependUOffsetTRelativeSlot(168, flatbuffers.number_types.UOffsetTFlags.py_type(BattlePassExpIconPath), 0)

    @staticmethod
    def AddCafeCameraDragThreshold(builder, CafeCameraDragThreshold): builder.PrependFloat32Slot(169, CafeCameraDragThreshold, 0)


    @staticmethod
    def AddCafeSummonTicketBuyLimitForValidate(builder, CafeSummonTicketBuyLimitForValidate): builder.PrependInt32Slot(170, CafeSummonTicketBuyLimitForValidate, 0)


    @staticmethod
    def AddAutoCraftPresetCountLimit(builder, AutoCraftPresetCountLimit): builder.PrependInt32Slot(171, AutoCraftPresetCountLimit, 0)


    @staticmethod
    def AddAutoCraftNodeSelectCount(builder, AutoCraftNodeSelectCount): builder.PrependInt32Slot(172, AutoCraftNodeSelectCount, 0)


    @staticmethod
    def AddCraftPresetNameMaxLength(builder, CraftPresetNameMaxLength): builder.PrependInt32Slot(173, CraftPresetNameMaxLength, 0)


    @staticmethod
    def AddSelectionWaitTime(builder, SelectionWaitTime): builder.PrependInt64Slot(174, SelectionWaitTime, 0)


    @staticmethod
    def AddRewardWaitTime(builder, RewardWaitTime): builder.PrependInt64Slot(175, RewardWaitTime, 0)


    @staticmethod
    def AddEpisodeContinueWaitTime(builder, EpisodeContinueWaitTime): builder.PrependInt64Slot(176, EpisodeContinueWaitTime, 0)


    @staticmethod
    def AddScenarioAutoDelayMillisecLong(builder, ScenarioAutoDelayMillisecLong): builder.PrependFloat32Slot(177, ScenarioAutoDelayMillisecLong, 0)


    @staticmethod
    def AddScenarioAutoDelayMillisec(builder, ScenarioAutoDelayMillisec): builder.PrependFloat32Slot(178, ScenarioAutoDelayMillisec, 0)


    @staticmethod
    def AddScenarioAutoDelayMillisecShort(builder, ScenarioAutoDelayMillisecShort): builder.PrependFloat32Slot(179, ScenarioAutoDelayMillisecShort, 0)


    @staticmethod
    def AddScenarioAutoDelayMillisecVeryShort(builder, ScenarioAutoDelayMillisecVeryShort): builder.PrependFloat32Slot(180, ScenarioAutoDelayMillisecVeryShort, 0)


    @staticmethod
    def AddPcBuildEnterInformation(builder, PcBuildEnterInformation): builder.PrependInt32Slot(181, PcBuildEnterInformation, 0)


    @staticmethod
    def AddComebackUserStandardDay(builder, ComebackUserStandardDay): builder.PrependInt32Slot(182, ComebackUserStandardDay, 0)


    @staticmethod
    def AddComebackUserLogSaveDay(builder, ComebackUserLogSaveDay): builder.PrependInt32Slot(183, ComebackUserLogSaveDay, 0)


    @staticmethod
    def AddComeBackActivateCooldown(builder, ComeBackActivateCooldown): builder.PrependInt32Slot(184, ComeBackActivateCooldown, 0)


    @staticmethod
    def AddCafeCopyPresetSlotCount(builder, CafeCopyPresetSlotCount): builder.PrependInt32Slot(185, CafeCopyPresetSlotCount, 0)


    @staticmethod
    def AddExpiryProductDailyRecordItemReceiveDay(builder, ExpiryProductDailyRecordItemReceiveDay): builder.PrependInt32Slot(186, ExpiryProductDailyRecordItemReceiveDay, 0)


    @staticmethod
    def AddNewbieUserStandardDay(builder, NewbieUserStandardDay): builder.PrependInt32Slot(187, NewbieUserStandardDay, 0)


    @staticmethod
    def AddNewbieStateHoldDay(builder, NewbieStateHoldDay): builder.PrependInt32Slot(188, NewbieStateHoldDay, 0)


    @staticmethod
    def AddClearDeckEchelonShowMaxCount(builder, ClearDeckEchelonShowMaxCount): builder.PrependInt32Slot(189, ClearDeckEchelonShowMaxCount, 0)
