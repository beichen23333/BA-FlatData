...
class LocalizeGachaShopExcel:
    ...
    @staticmethod
    def AddGachaShopId(builder, GachaShopId): builder.PrependInt32Slot(0, GachaShopId, 0)
    ...
    @staticmethod
    def AddGachaPeriodCN(builder, GachaPeriodCN): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(GachaPeriodCN), 0)
