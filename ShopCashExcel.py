...
class ShopCashExcel:
    ...
    @staticmethod
    def AddRenewalDisplayOrder(builder, RenewalDisplayOrder): builder.PrependInt32Slot(6, RenewalDisplayOrder, 0)
    ...
    @staticmethod
    def AddAccountLevelLimit(builder, AccountLevelLimit): builder.PrependInt32Slot(12, AccountLevelLimit, 0)
    ...
    @staticmethod
    def AddClearMissionLimit(builder, ClearMissionLimit): builder.PrependInt32Slot(14, ClearMissionLimit, 0)
