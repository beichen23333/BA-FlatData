...
class MiniGameMissionExcel:
    ...
    @staticmethod
    def AddCompleteConditionMissionId(builder, CompleteConditionMissionId): builder.PrependUOffsetTRelativeSlot(21, flatbuffers.number_types.UOffsetTFlags.py_type(CompleteConditionMissionId), 0)
    @staticmethod
    def StartCompleteConditionMissionIdVector(builder, numElems): return builder.StartVector(8, numElems, 8)


    @staticmethod
    def AddCompleteConditionMissionCount(builder, CompleteConditionMissionCount): builder.PrependInt64Slot(22, CompleteConditionMissionCount, 0)


    @staticmethod
    def AddMissionRewardParcelType(builder, MissionRewardParcelType): builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(MissionRewardParcelType), 0)
    @staticmethod
    def StartMissionRewardParcelTypeVector(builder, numElems): return builder.StartVector(4, numElems, 4)


    @staticmethod
    def AddMissionRewardParcelId(builder, MissionRewardParcelId): builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(MissionRewardParcelId), 0)
    @staticmethod
    def StartMissionRewardParcelIdVector(builder, numElems): return builder.StartVector(8, numElems, 8)


    @staticmethod
    def AddMissionRewardAmount(builder, MissionRewardAmount): builder.PrependUOffsetTRelativeSlot(25, flatbuffers.number_types.UOffsetTFlags.py_type(MissionRewardAmount), 0)
    @staticmethod
    def StartMissionRewardAmountVector(builder, numElems): return builder.StartVector(4, numElems, 4)


    @staticmethod
    def AddConditionRewardParcelType(builder, ConditionRewardParcelType): builder.PrependUOffsetTRelativeSlot(26, flatbuffers.number_types.UOffsetTFlags.py_type(ConditionRewardParcelType), 0)
    @staticmethod
    def StartConditionRewardParcelTypeVector(builder, numElems): return builder.StartVector(4, numElems, 4)


    @staticmethod
    def AddConditionRewardParcelId(builder, ConditionRewardParcelId): builder.PrependUOffsetTRelativeSlot(27, flatbuffers.number_types.UOffsetTFlags.py_type(ConditionRewardParcelId), 0)
    @staticmethod
    def StartConditionRewardParcelIdVector(builder, numElems): return builder.StartVector(8, numElems, 8)


    @staticmethod
    def AddConditionRewardAmount(builder, ConditionRewardAmount): builder.PrependUOffsetTRelativeSlot(28, flatbuffers.number_types.UOffsetTFlags.py_type(ConditionRewardAmount), 0)
    @staticmethod
