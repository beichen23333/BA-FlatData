...
class EmblemExcel:
    ...
    @staticmethod
    def AddEmblemParameter(builder, EmblemParameter): builder.PrependInt64Slot(20, EmblemParameter, 0)


    @staticmethod
    def AddCheckPassCount(builder, CheckPassCount): builder.PrependInt64Slot(21, CheckPassCount, 0)
