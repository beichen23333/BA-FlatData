...
class EmblemExcel:
    ...
    @staticmethod
    def AddEmblemBGPathTh(builder, EmblemBGPathTh): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(EmblemBGPathTh), 0)

    @staticmethod
    def AddEmblemBGPathTw(builder, EmblemBGPathTw): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(EmblemBGPathTw), 0)

    @staticmethod
    def AddEmblemBGPathEn(builder, EmblemBGPathEn): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(EmblemBGPathEn), 0)

    @staticmethod
    def AddEmblemEffectPath(builder, EmblemEffectPath): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(EmblemEffectPath), 0)

    @staticmethod
    def AddDisplayType(builder, DisplayType): builder.PrependInt32Slot(18, DisplayType, 0)


    @staticmethod
    def AddDisplayStartDate(builder, DisplayStartDate): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(DisplayStartDate), 0)

    @staticmethod
    def AddDisplayEndDate(builder, DisplayEndDate): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(DisplayEndDate), 0)

    @staticmethod
    def AddDislpayFavorLevel(builder, DislpayFavorLevel): builder.PrependInt32Slot(21, DislpayFavorLevel, 0)


    @staticmethod
    def AddCheckPassType(builder, CheckPassType): builder.PrependInt32Slot(22, CheckPassType, 0)
