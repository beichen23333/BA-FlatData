...
class ShopRecruitExcel:
    ...
    @staticmethod
    def AddDirectPayProductId(builder, DirectPayProductId): builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(DirectPayProductId), 0)
