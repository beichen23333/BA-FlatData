...
class ProductBattlePassExcel:
    ...
    @staticmethod
    def AddPurchaseCountLimit(builder, PurchaseCountLimit): builder.PrependInt64Slot(4, PurchaseCountLimit, 0)


    @staticmethod
    def AddBattlePassProductGroupId(builder, BattlePassProductGroupId): builder.PrependInt64Slot(5, BattlePassProductGroupId, 0)


    @staticmethod
    def AddParcelType(builder, ParcelType): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(ParcelType), 0)
    @staticmethod
