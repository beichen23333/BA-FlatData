...
class MiniGameRoadPuzzleInfoExcel:
    __slots__ = ['_tab']
    ...
    @staticmethod
    def AddEventUseCostType(builder, EventUseCostType): builder.PrependInt32Slot(1, EventUseCostType, 0)
    ...
    @staticmethod
    def AddInstantClearRound(builder, InstantClearRound): builder.PrependInt32Slot(5, InstantClearRound, 0)
